...
public class Load1CrossAutoChargeStationAutoCommand extends SequentialCommandGroup {
  private final ArmSubsystem m_armSubsystem;
  private final DriveSubsystem m_driveSubsystem;
  private final GripperSubsystem m_gripperSubsystem;

  /** Creates a new Load1CrossAutoChargeStation. */
  public Load1CrossAutoChargeStationAutoCommand(ArmSubsystem armSubsystem, DriveSubsystem driveSubsystem, GripperSubsystem gripperSubsystem) {
  ...
  private Command autoBalance() {
    return new AutoBalanceCommand(this.m_driveSubsystem);
  }
