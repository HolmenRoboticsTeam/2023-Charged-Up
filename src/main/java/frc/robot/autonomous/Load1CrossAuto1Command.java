...
public class Load1CrossAuto1Command extends SequentialCommandGroup {
  private final ArmSubsystem m_armSubsystem;
  private final DriveSubsystem m_driveSubsystem;
  private final GripperSubsystem m_gripperSubsystem;

  /** Creates a new Load1CrossAutoCommand. */
  public Load1CrossAuto1Command(ArmSubsystem armSubsystem, DriveSubsystem driveSubsystem, GripperSubsystem gripperSubsystem) {
  ...
  private Command closeGripper() {
    return new SequentialCommandGroup(
      new InstantCommand(this.m_gripperSubsystem::close, this.m_gripperSubsystem),
      new WaitCommand(0.5)
    );
  }
