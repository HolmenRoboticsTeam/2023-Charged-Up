...
public class Load2CrossAuto1 extends SequentialCommandGroup {
  private final ArmSubsystem m_armSubsystem;
  private final DriveSubsystem m_driveSubsystem;
  private final GripperSubsystem m_gripperSubsystem;

  /** Creates a new Load2CrossAuto1. */
  public Load2CrossAuto1(ArmSubsystem armSubsystem, DriveSubsystem driveSubsystem, GripperSubsystem gripperSubsystem) {
