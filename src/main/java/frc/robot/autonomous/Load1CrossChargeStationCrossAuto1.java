...
public class Load1CrossChargeStationCrossAuto1 extends SequentialCommandGroup {
  private final ArmSubsystem m_armSubsystem;
  private final DriveSubsystem m_driveSubsystem;
  private final GripperSubsystem m_gripperSubsystem;

  /** Creates a new Load1CrossAutoChargeStation. */
  public Load1CrossChargeStationCrossAuto1(ArmSubsystem armSubsystem, DriveSubsystem driveSubsystem, GripperSubsystem gripperSubsystem) {
  ...
  public Command loadPath() {
    List<PathPlannerTrajectory> pathGroup = PathPlanner.loadPathGroup(
      "Load1-CrossChargeStation-CrossAuto1",
