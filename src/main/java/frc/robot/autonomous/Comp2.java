...
public class Comp2 extends SequentialCommandGroup {
  private final ArmSubsystem m_armSubsystem;
  private final DriveSubsystem m_driveSubsystem;
  private final GripperSubsystem m_gripperSubsystem;

  /** Creates a new Load2 */
  public Comp2(ArmSubsystem armSubsystem, DriveSubsystem driveSubsystem, GripperSubsystem gripperSubsystem) {
  ...
  private Command retractArmHome() {
    return new SequentialCommandGroup(new ArmRetractToHomeCommand(m_armSubsystem), new ArmPivotToHomeCommand(m_armSubsystem));
  }
