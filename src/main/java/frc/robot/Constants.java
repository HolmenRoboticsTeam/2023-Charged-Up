...
public final class Constants {
  ...
  public static final class ArmConstants {
    ...
    // Drum diameter is averaged between fully contracted and fully extended wraps
    // of the rope
    ...
    // Setting up motor reductions for extention and pivot. Using FreeSpeedRPS to
    // calculate FF for the pivot motor.
    ...
    public static final double kFullyContractedLengthMeters = 1.035; // Middle of drum to tip of gripper (rope length);
                                                                     // Units.inchesToMeters(40.75);
  ...
  // Angle and length of arm depending on button pressed. These are not the
  // correct values
  ...
  public static final class DriveConstants {
    ...
    public static final double kMaxSpeedMetersPerSecond = 2.0; // 4.8 IS MAX SPEED
